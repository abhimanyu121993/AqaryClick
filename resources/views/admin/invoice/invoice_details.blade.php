                                    ...
                                    <div class="card-body p-4">
                                        <div class="row g-3">
                                            <div class="col-lg-3 col-6">
                                                ...
                                                <h5 class="fs-14 mb-0"><span id="invoice-no">{{$invoice->invoice_no??''}}</span></h5>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                                <p class="text-muted mb-2 text-uppercase fw-semibold">Date</p>
                                                <h5 class="fs-14 mb-0"><span id="invoice-date">{{\Carbon\Carbon::parse($invoice->created_at)->format('d M Y')??''}}</span></h5>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                                <p class="text-muted mb-2 text-uppercase fw-semibold">Payment Status</p>
                                                <span class="badge badge-soft-success fs-11" id="payment-status">{{$invoice->payment_status??''}}</span>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card-body p-4 border-top border-top-dashed">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                ...
                                                <p class="fw-medium mb-2" id="billing-name">{{$lessor->first_name??''}}</p>
                                                <p class="text-muted mb-1" id="billing-address-line-1">{{$lessor->address??''}}</p>
                                                <p class="text-muted mb-1"><span>Phone: +</span><span id="billing-phone-no">{{$lessor->mobile??''}}</span></p>
                                            ...
                                            <div class="col-6 text-center">
                                                ...
                                                <p class="fw-medium mb-2" id="shipping-name">{{$invoice->TenantName->tenant_english_name??''}}</p>
                                                <p class="text-muted mb-1" id="shipping-address-line-1">Address: <br>{{$invoice->TenantName->unit_address??''}} </p>
                                                <p class="text-muted mb-1"><span>Phone:</span><span id="shipping-phone-no">{{$invoice->TenantName->tenant_primary_mobile??''}},{{$invoice->TenantName->tenant_secondry_mobile??''}}</span></p>
                                            </div>
                                            <!--end col-->
                                        </div>
                                        <!--end row-->
    ...
    window.onload = function() {
        document.getElementById("download")
            .addEventListener("click", () => {
                const invoice = this.document.getElementById("invoice-download");
                console.log(invoice);
                console.log(window);
                var opt = {
