            ...
            <div class="card">
                ...
                <form class="needs-validation" novalidate id="invoice_form" action="{{ route('admin.invoice.store') }}"
                    ...
                    <div class="card-body p-4">
                        ...
                        <input type="hidden" class="form-control tenant_id" id="tenant_id" value=""
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="overdue_period" name="overdue_period"
                                        placeholder="Overdue Period" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="account_no" name="tenant_account"
                            ...
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="sender_name" name="tenant_sender"
                            ...
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="file" class="form-control" id="attachment_file"
                                        name="tenant_attachment[]" multiple>
                                </div>
                            </div>
                            <!-- <div class="col-xxl-3 col-md-3">
                        ...
                        <div class="row">
                            <div class="col-xxl-3 col-md-4">
                                <label class="form-label" for="flag">Account No.</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="benifitary_account_no"
                                        name="benifitary_account" placeholder="Enter Account No">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="name" class="form-label">Bank Name</label>
                            ...
                            <div class="col-xxl-3 col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="benifitary_name"
                                        name="benifitary_name" placeholder="Enter Benifitary Name">
                                </div>
                            </div>
                        </div>
                        <div class="card mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="amt_paid" name="amt_paid"
                                    ...
                                    <div class="card-body table-responsive">
                                        <div class="live-preview">
                                            <div class="table-responsive">
                                                <table
                                                    class="invoice-table table table-borderless table-nowrap mb-0 table-responsive ">
                                                        ...
                                                        <tr id="1" class="product parent_cheque">
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    id="productName-1" name="deposite_date[]"
                                                                    placeholder="Product Name" required />
                                                                <textarea class="form-control mt-1" id="productDetails-1" name="cheque_remark[]" rows="3" cols="50"
                                                                    placeholder="Enter Remark"></textarea>
                                                            </td>
                                                            <td class="text-end">
                                                                <select class="form-control select2 form-select currency "
                                                                    name="currency[]" id="currency">
                                                                    {!! $currencyhtml !!}
                                                                </select>
                                                                <input type="file" class="form-control mt-1"
                                                                    name="file[]" id="product-qty-1" multiple>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control cheque_amt"
                                                                    name="cheque_amt[]" id="product-qty-1"
                                                                    placeholder="Enter Cheque Amount">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control sar_amt"
                                                                    name="sar_amt[]" id="product-qty-1"
                                                                    placeholder="Amount in QAR" readonly />
                                                            </td>
                                                            <td class="text-end">
                                                                <select class="form-control select2 form-select"
                                                                    name="cheque_status[]" id="currency">
                                                            ...
                                                            <td class="text-end">
                                                                <input type="text" class="form-control"
                                                                    id="productPrice-1" name="cheque_no[]"
                                                                    placeholder="Cheque No" />

                                                            </td>
                                                            <td class="text-end">
                                                                <select class="form-control select2 form-select "
                                                                    name="cheque_bank_name[]" id="bank">
                                                                    {!! $bankhtml !!}
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mt-4">
                                <label for="exampleFormControlTextarea1"
                                    class="form-label text-muted text-uppercase fw-semibold">Remark</label>
...
@section('script-area')
    ...
    <script>
        function new_link() {
            ...
            var t = '<tr><th scope="row" class="product-id">' + count +
                '</th><td class="text-start"><input type="date" class="form-control" "deposite_date[]" id="deposite_date-"' +
                count + '" name="deposite_date[]"/>\
        <textarea class="form-control" id="cheque_remark-"' + count +
                '" rows="3" cols="50" placeholder="Product Details" name="cheque_remark[]"></textarea>\
        ...
        <option value="Security Cheque">Security Cheque</option>/</select>\
        </td><td class="text-end"><input type="text" class="form-control product-line-price" id="cheque_no-"' + count +
                '" placeholder="Cheque No" name="cheque_no[]"  />\
            ...
            e.innerHTML = document.getElementById("newForm").innerHTML + t, document.getElementById("newlink").appendChild(
                e);
