        ...
        <div class="col-lg-12">
            <div class="card" id="header1">
                <div class="card-header align-items-center d-flex" id="card-header">
                    <h4 class="card-title mb-0 flex-grow-1" id="h1">{{ isset($city)? 'Update City' : 'Create City' }}</h4>
                </div><!-- end card header -->
                <div class="card-body">
                            ...
                            <div class="col-xxl-3 col-md-6">
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-primary" id="btn-btn" type="submit">{{isset($city) ? 'Update' : 'Submit'}}</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li><a class="dropdown-item" id="pop" href="{{route('admin.city.edit',$bid)}}">Edit</a></li>
