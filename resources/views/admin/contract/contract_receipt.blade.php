...
<html lang="en">
  ...
  <!-- <thead class="thead-dark">
    <tr>
      <th scope="col-6"><p>Contract No:RE/HTC/0005</p>
      <p>Customer No:MU/HTC/015</p></th>
      <th scope="col-6"><p class="text-end"></p>
        <p> MU / HTC / 015: رقم العميل  </p>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>This LEASE AGREEMENT is made as of September 12<sup>th</sup> by and between the following Parties</td>
      <td>Otto</td>
    </tr>
    <tr>
      <td>Jacob</td>
