        ...
        <div style="margin:0 auto;width:100%;max-width:598px;text-align:center;background-color:#ffffff">
            ...
            <div style="font-size:0;background-color:#ffffff">
                ...
                <div style="display:inline-block;width:70%;vertical-align:top;color: #f08a48;text-align:center">
                    <div style="font-size:42px;font-weight:bold;padding-bottom:12px;padding-top:25px">Welcome &nbsp; {{$user->name }}
                    ...
                    <table style="margin:auto">
                        <tbody>
                            <tr>
                                <td style="color:#10e6e6;font-size:14px;padding:6px">User Name</td>
                    ...
                    <table style="margin:auto">
                        <tbody>
                            <tr>
                                <td style="color:#10e6e6;font-size:14px;padding:6px;white-space:nowrap">User Mobile</td>
                                <td style="color:#10e6e6;font-size:14px;white-space:nowrap">{{$user->phone}}</td>
                            </tr>
                        </tbody>
                    </table>
