                    ...
                    <form action="{{ isset($buildingedit) ? route('admin.register_building.update', $buildingedit->id) : route('admin.register_building.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-4 mb-3">
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="building_code" name="building_code" value="{{isset($buildingedit)? $buildingedit->building_code: old('building_code') }}" placeholder="Building Code" >
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Building Name</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="name" name="building_name" value="{{isset($buildingedit)? $buildingedit->name: old('building_name') }}" placeholder="Building Name">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <select class="select2  form-select js-example-basic-single" id="building_type" name="building_type">
                                  <option value="" selected hidden>--Select Building Type--</option>
                                    ...
                                    <option value="{{ $type->name}}"{{ isset($buildingedit)? ($buildingedit->building_type == $type->name ? 'selected' : '') :(old('building_type')==$type->name?'selected':'') }} >{{ $type->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                ...
                                @if (isset($buildingedit))
                                            <option value="{{ $buildingedit->status ??''}}"selected hidden>
                                                ...
                                                @else
                                            <option value="{{old('status','')}}" selected hidden>{{old('status','--Select Status--')}}</option>
                                        @endif                                    
                        ...
                        <div class="row gy-4 mb-3">
                            <div class="col-xxl-3 col-md-3">
                                ...
                                @if (isset($buildingedit))
                                            <option value="{{ $buildingedit->ownership_type ??''}}" selected hidden>
                                                ...
                                                @else
                                            <option value="{{old('ownership_type','')}}" selected hidden>{{old('ownership_type','--Select OwnershipType--')}}</option>
                                        @endif                              
                            ...
                            <div class="col-xxl-3 col-md-3" id="title">
                                ...
                                <div class="input-group">
                                <input type="text" class="form-control" id="ownership_no" name="ownership_no" value="{{isset($buildingedit)? $buildingedit->ownership_no:old('ownership_no') }}" placeholder="Enter Title Deed No">
                                </div>
                            ...
                            <div class="col-xxl-3 col-md-3" id="contract">
                                ...
                                <div class="input-group" id="contract">
                                    <input type="text" class="form-control" id="contract_no" name="contract_no" value="{{isset($buildingedit)? $buildingedit->contract_no: old('contract_no') }}" placeholder="Enter contract Number">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3" id="contract_exp" >
                                <label for="owner_name" class="form-label" >Usufruct Contract Expiry Date</label>
                                <div class="input-group" id="contract">
                                    <input type="date" class="form-control" name="contract_exp" value="{{isset($buildingedit)? $buildingedit->contract_exp: old('contract_exp') }}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="pincode" class="form-label">Pin No</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="pincode" name="pincode" value="{{isset($buildingedit)? $buildingedit->pincode: old('pincode') }}" placeholder="Pincode">
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-md-12">
                                ...
                                {{isset($buildingedit)? $buildingedit->building_desc: old('building_desc') }}
                                    </textarea>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="owner_name" class="form-label">Owner Name</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="owner_name" name="owner_name" value="{{isset($buildingedit)? $buildingedit->owner_name: old('owner_name') }}" placeholder="Owner Name">
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="name" class="form-control" id="lessor_name" name="lessor_name" value="{{isset($buildingedit)? $buildingedit->lessor_name: old('lessor_name') }}" placeholder="Lessor's Name">
                                </div>
                            </div>
                        ...
                        <div class="row gy-4 mb-3">
                            <div class="col-md-4 mb-1">
                                ...
                                <option value="{{ $cd->id ??'' }}" {{ isset($buildingedit)? ($buildingedit->country == $cd->id ? 'selected' : '') :(old('country')==$cd->id?'selected':'') }}>{{ $cd->name ?? '' }}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row gy-4 mb-3">
                            ...
                            <div class="col-xxl-3 col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="building_no" name="building_no" value="{{isset($buildingedit)? $buildingedit->building_no: old('building_no') }}" placeholder="Enter Building No">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="city" class="form-label">Street No</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="street_no" name="street_no" value="{{isset($buildingedit)? $buildingedit->street_no: old('street_no') }}" placeholder="Enter Street No">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="area" class="form-label">Zone No</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="zone_no" name="zone_no" value="{{isset($buildingedit)? $buildingedit->zone_no: old('zone_no') }}" placeholder="Enter Zone No">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gy-4 mb-3">
                            ...
                            <div class="col-xxl-3 col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="building_location" name="building_location" value="{{isset($buildingedit)? $buildingedit->location: old('building_location') }}" placeholder="Google Map Link">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-3 col-md-4">
                                ...
                                <div class="input-group">
                                    <input id="dateInput" type="date" class="form-control" id="building_cdate" name="construction_date" value="{{isset($buildingedit)? $buildingedit->construction_date: old('construction_date') }}" placeholder="12-12-2022">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="building_location" class="form-label">Building Age</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="building_age" name="building_age" value="{{isset($buildingedit)? $buildingedit->building_age: old('building_age') }}" placeholder="Building Age" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                ...
                                <select class="select2  form-select " id="building_status" name="building_status">
                                    ...
                                    <option value="{{ $buildingedit->building_status ?? old('building_status','') }}" selected hidden>{{ $buildingedit->building_status ??old('building_status','--Select Status--')}}</option>
                            ...
                            <div class="col-xxl-3 col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="space" name="built_up_area" value="{{isset($buildingedit)? $buildingedit->space: old('built_up_area') }}" placeholder="Built Up Area (Sq.Meter)">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="incharge_name" class="form-label">Cost Building <sup class="text-danger">(per square meter)</sup></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="cost_building" name="cost_building" value="{{isset($buildingedit)? $buildingedit->cost_building: old('cost_building') }}" placeholder="Enter Building Cost(Sq.Meter)">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-4">
                                <label for="country" class="form-label">Total Building Value</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="building_value" name="building_value" value="{{isset($buildingedit)? $buildingedit->building_value: old('building_value') }}" placeholder="Enter Building Value" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Land Area <sup class="text-danger">(in square meter)</sup></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="landsize_meter" name="landsize_meter" value="{{isset($buildingedit)? $buildingedit->landsize_meter: old('landsize_meter') }}" placeholder="Land Size(Sq.Meter)">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="incharge_name" class="form-label">Land Area <sup class="text-danger">(in square foot)</sup></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="land_size" name="land_size_foot" value="{{isset($buildingedit)? $buildingedit->land_size_foot: old('land_size_foot') }}" placeholder="Enter Land Size(Sq.Foot)" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="country" class="form-label">Price per square foot</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="price_foot" name="price_foot" value="{{isset($buildingedit)? $buildingedit->price_foot: old('price_foot') }}" placeholder="Enter Price per square foot">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="state" class="form-label">Total Land Value</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="total_land" name="total_land" value="{{isset($buildingedit)? $buildingedit->total_land: old('total_land') }}" placeholder="Enter Total Land" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="state" class="form-label">Monthly Income</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="monthly_income" name="monthly_income" value="{{isset($buildingedit)? $buildingedit->monthly_income: old('monthly_income') }}" placeholder="Enter Monthly Income">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Annual Income</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="annual_income" name="annual_income" value="{{isset($buildingedit)? $buildingedit->annual_income: old('annual_income') }}" placeholder="Enter Annual Income" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="state" class="form-label">Payback Period</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="payback" name="payback" value="{{isset($buildingedit)? $buildingedit->payback: old('payback') }}" placeholder="Enter Payback " readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Total Net Property</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="property_vlaue" name="property_vlaue" value="{{isset($buildingedit)? $buildingedit->property_vlaue: old('property_vlaue') }}" placeholder="Enter Total Property Value" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Appraise Property Date</label>
                                <div class="input-group">
                                    <input type="date" class="form-control" id="appraise_date" name="appraise_date" value="{{isset($buildingedit)? $buildingedit->appraise_date: old('appraise_date') }}" placeholder="12-12-2022">
                                </div>
                            </div>
                        ...
                        <div class="row gy-4 mb-3">
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="incharge_name" name="incharge_name" value="{{isset($buildingedit)? $buildingedit->person_incharge: old('incharge_name') }}" placeholder="Person In-Charge">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="country" class="form-label">Job</label>
                                <div class="input-group">
                                    <input type="text" class="form-control"  name="person_job" value="{{isset($buildingedit)? $buildingedit->person_job: old('person_job') }}" placeholder="Enter job">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="state" class="form-label">Mobile No.</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="mobile" name="person_mobile" value="{{isset($buildingedit)? $buildingedit->person_mobile: old('person_mobile') }}" placeholder="Enter mobile">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-3">
                                <label for="name" class="form-label">Building Recieve Date</label>
                                <div class="input-group">
                                    <input type="date" class="form-control" id="building_rdate" name="building_receive_date" value="{{isset($buildingedit)? $buildingedit->building_receive_date: old('building_receive_date') }}" placeholder="12-12-2022">
                                </div>
                            </div>
                        </div>
                        <div class="card" id="header1">
