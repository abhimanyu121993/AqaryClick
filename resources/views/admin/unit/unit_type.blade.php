        ...
        <div class="col-lg-12">
            <div class="card" id="header1">
                <div class="card-header align-items-center d-flex table-main-heading" id="card-header">
                    <h4 class="card-title mb-0 flex-grow-1" id="h1">{{ isset($unitedit)? 'Update Unit Type' : 'Create Unit Type' }}</h4>
                </div><!-- end card header -->
                <div class="card-body">
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-primary" id="btn-btn" type="submit">{{isset($unitedit) ? 'Update' : 'Submit'}}</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li><a class="dropdown-item" id="pop" href="{{route('admin.unit-type.edit',$bid)}}">Edit</a></li>
