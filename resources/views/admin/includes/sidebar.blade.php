...
<div class="app-menu navbar-menu" style="background-image: linear-gradient(#0D324D,#7F5A83);">
    ...
    <div class="navbar-brand-box" style="background-image: linear-gradient(#ffffff,#ffffff);">
        ...
        <a href="#" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="{{ asset('aquary.png') }}" alt="" height="80" style="filter: drop-shadow(3px 3px 3px rgb(78, 77, 77));"></span>
            </span>
        </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards2">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.ImportExportBuilding') }}" class="nav-link" data-key="t-analytics">Import/Export</a>
                            </li>
                            @endcan
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards3">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.ImportExportUnit') }}" class="nav-link" data-key="t-analytics">Import/Export</a>
                            </li>
                            @endcan
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards4">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.ImportExportTenant') }}" class="nav-link" data-key="t-analytics">Import/Export</a>
                            </li>
                            @endcan
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards8">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.ImportExportContract') }}" class="nav-link" data-key="t-analytics">Import/Export</a>
                            </li>
                            @endcan
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards11">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.legal.index') }}" class="nav-link" data-key="t-analytics">Legal</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.legalReport') }}" class="nav-link" data-key="t-analytics">Legal Report</a>
                            </li>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarDashboards122552">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('admin.contract-recipt.index') }}" class="nav-link" data-key="t-analytics">Contract Receipt Update </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('admin.currency.index') }}" class="nav-link" data-key="t-analytics">Currency</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('admin.nationality.index') }}" class="nav-link" data-key="t-analytics">Country</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarDashboards12223589">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{ route('admin.membership.index') }}" class="nav-link" data-key="t-analytics"><i data-feather="users" class="icon-dual"></i> Membership </a>
                                        </li>
