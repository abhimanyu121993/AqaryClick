        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    @endif --}}
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2" id="qid">
                            ...
                            <div class="col-md-6 mb-2" id="passport">
                        ...
                        <div class=" col-md-6">
                            ...
                            <div class="col-md-6" id="authp">
                                <label for="country" class="form-label">Renatl Period</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="country" class="form-label">Receipt Of Cheques</label>&nbsp;&nbsp;&nbsp;
