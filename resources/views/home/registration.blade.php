            ...
            <div class="row hide_reg">
                <div class="card col-3 account-li" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Already Register with us? if so, click the button below to login to our
                            client area from where you can manage your account</li>
                        <li class="list-group-item">Login <span><i class="fa fa-sign-in" aria-hidden="true"
                                    style="float: right;"></i></span></li>
                        <li class="list-group-item">Reset Forget Password <span><i class="fa fa-key" aria-hidden="true"
                                    style="float: right;"></i></span></li>
                    </ul>
                </div>
                <div class="alert alert-danger col-9" role="alert" style="height:50px; margin-left:10px;">
                    To create an account Please View <a href="#" id="our_plan" class="btn-sm btn-info">Our Plans</a>
                </div>
            </div>
            <div class="show_plan">
