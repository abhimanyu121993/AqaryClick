            ...
            <div class="theme-container">  
                <div class="row center-xs middle-xs my-5"> 
                    <div class="mdc-card p-3 p-relative mw-500px w-100">
                        ...
                        <form action="{{route('home.reset-password-post')}}" method="post">  
                            @csrf
                            <input type="hidden" value='{{$token}}' name="token">
                            <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon mdc-text-field--with-trailing-icon w-100 custom-field mt-3 @if($errors->any()) mdc-text-field--invalid @else '' @endif">
                                <i class="material-icons mdc-text-field__icon text-muted">lock</i>
                                <i class="material-icons mdc-text-field__icon text-muted" tabindex="1" id="password-toggle" role="button">visibility_off</i>
                            ...
                            <div class="mdc-text-field-helper-line">
                                <div class="mdc-text-field-helper-text mdc-text-field-helper-text--validation-msg">@error('password_confirmation')
                                    {{$message}}
                                @enderror</div>
                            </div>
