            ...
            <div class="theme-container">  
                <div class="row center-xs middle-xs my-5"> 
                    <div class="mdc-card p-3 p-relative mw-500px w-100">
                        ...
                        <form action="{{route('home.forget-password-post')}}" method="post">  
                            @csrf
                            <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon w-100 mt-3 custom-field @if($errors->any()) mdc-text-field--invalid @else '' @endif">
                            ...
                            <div class="text-center mt-2"> 
                                <button class="mdc-button mdc-button--raised bg-accent" type="submit">
                                    ...
                                    <span class="mdc-button__label">Send Link</span> 
                                </button>
                            </div>  
