    ...
    <main class="content-offset-to-top">
        <div class="header-image-wrapper">
            ...
            <div class="header-image-content offset-bottom">
                ...
                <p class="desc">We help you for find your house on Aqaryclick</p>
            </div>
        </div>
        <div class="px-3">
                            ...
                            <div class="theme-container">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6 p-3">
                                        ...
                                        <p class="mt-2">{!! $data->where('key','aboutus')->first()->value?? '' !!}</p>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 p-3">
                                        <div class="row start-xs middle-xs">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="content text-center">
                                         <img src="{{asset('home2/assets/images/profile/adam.jpg')}}" alt="adam">
                                ...
                                <div class="swiper-slide">
                                    <div class="content text-center">
                                        <img src="{{asset('home2/assets/images/profile/ashley.jpg')}}" alt="ashley">
                                        <div class="quote open text-left primary-color">“</div>
                                        <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida, at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada. Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>
                                        <div class="quote close text-right primary-color">”</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="content text-center">
                                        <img src="{{asset('home2/assets/images/profile/bruno.jpg')}}" alt="bruno">
                                        <div class="quote open text-left primary-color">“</div>
                                        <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida, at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada. Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>
                                        <div class="quote close text-right primary-color">”</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="content text-center">
                                        <img src="{{asset('home2/assets/images/profile/julia.jpg')}}" alt="julia">
                                        <div class="quote open text-left primary-color">“</div>
                                        <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida, at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada. Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>
                                        <div class="quote close text-right primary-color">”</div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset($pro->file)}}" alt="slide image" data-src="{{asset($pro->file)}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                            <h2 class="fw-600">{{ $pro->full_name }}</h2>
                                            ...
                                            <p class="mt-3 text-muted fw-500">{{ $pro->description }}</p>
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">{{ $pro->profile_status }}</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">{{ $pro->email }}</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">call</i><span class="mx-2 text-muted fw-500">{{ $pro->phone }}</span></p>
                                            <div class="row pb-3">
                                                <div class="divider"></div>
                                            </div>
                                            <div class="row between-xs middle-xs">
                                                <div class="row start-xs middle-xs">
                                                    <a href="{{ $pro->facebook }}" target="blank" class="social-icon" title="facebook">
                                                        <svg class="material-icons text-muted" viewBox="0 0 24 24">
                                                          <path d="M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M18,5H15.5A3.5,3.5 0 0,0 12,8.5V11H10V14H12V21H15V14H18V11H15V9A1,1 0 0,1 16,8H18V5Z" />
                                                        </svg>
                                                    </a>
                                                    <a href="{{ $pro->twiter }}" target="blank" class="social-icon" title="twitter">
                                                        <svg class="material-icons text-muted" viewBox="0 0 24 24">
                                                            <path d="M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M17.71,9.33C18.19,8.93 18.75,8.45 19,7.92C18.59,8.13 18.1,8.26 17.56,8.33C18.06,7.97 18.47,7.5 18.68,6.86C18.16,7.14 17.63,7.38 16.97,7.5C15.42,5.63 11.71,7.15 12.37,9.95C9.76,9.79 8.17,8.61 6.85,7.16C6.1,8.38 6.75,10.23 7.64,10.74C7.18,10.71 6.83,10.57 6.5,10.41C6.54,11.95 7.39,12.69 8.58,13.09C8.22,13.16 7.82,13.18 7.44,13.12C7.81,14.19 8.58,14.86 9.9,15C9,15.76 7.34,16.29 6,16.08C7.15,16.81 8.46,17.39 10.28,17.31C14.69,17.11 17.64,13.95 17.71,9.33Z" />
                                                        </svg>
                                                    </a>
                                                    <a href="{{ $pro->linkedin }}" target="blank" class="social-icon" title="linkedin">
                                                        <svg class="material-icons text-muted" viewBox="0 0 24 24">
                                                          <path d="M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19M18.5,18.5V13.2A3.26,3.26 0 0,0 15.24,9.94C14.39,9.94 13.4,10.46 12.92,11.24V10.13H10.13V18.5H12.92V13.57C12.92,12.8 13.54,12.17 14.31,12.17A1.4,1.4 0 0,1 15.71,13.57V18.5H18.5M6.88,8.56A1.68,1.68 0 0,0 8.56,6.88C8.56,5.95 7.81,5.19 6.88,5.19A1.69,1.69 0 0,0 5.19,6.88C5.19,7.81 5.95,8.56 6.88,8.56M8.27,18.5V10.13H5.5V18.5H8.27Z" />
                                                        </svg>
                                                    </a>
                                                    <a href="{{ $pro->instagram }}" target="blank" class="social-icon" title="instagram">
                                                        <svg class="material-icons text-muted" viewBox="0 0 24 24">
                                ...
                                {{-- <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset('home2/assets/images/others/transparent-bg.png')}}" alt="slide image" data-src="{{asset('home2/./assets/images/agents/a-2.jpg')}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                {{-- <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset('home2/assets/images/others/transparent-bg.png')}}" alt="slide image" data-src="{{asset('home2/./assets/images/agents/a-3.jpg')}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                {{-- <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset('home2/assets/images/others/transparent-bg.png')}}" alt="slide image" data-src="{{asset('home2/./assets/images/agents/a-4.jpg')}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                {{-- <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset('home2/assets/images/others/transparent-bg.png')}}" alt="slide image" data-src="{{asset('home2/./assets/images/agents/a-5.jpg')}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
