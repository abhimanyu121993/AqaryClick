...
<head>
    ...
    <title>AqaryClick | Home</title>
    <link rel="icon" type="image/x-icon" href="{{asset('home2/assets/favicon.ico')}}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700">
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    <link rel="stylesheet" href="{{asset('home2/css/libs/swiper.min.css')}}">
    <link rel="stylesheet" href="{{asset('home2/css/libs/material-components-web.min.css')}}">
    <link rel="stylesheet" href="{{asset('home2/style.css')}}">
    <link rel="stylesheet" href="{{asset('home2/css/skins/blue.css')}}">
    <link rel="stylesheet" href="{{asset('home2/css/responsive.css')}}">
</head>
<body class="mdc-theme--background">
    <div class="spinner-wrapper" id="preloader">
        <div class="spinner-container">
            <div class="spinner-outer">
                ...
                <p class="spinner-text">AqaryClick</p>
            </div>
        </div>
    </div>
    ...
    <script src="{{asset('home2/js/libs/jquery.min.js')}}"></script>
    <script src="{{asset('home2/js/libs/material-components-web.min.js')}}"></script>
    <script src="{{asset('home2/js/libs/swiper.min.js')}}"></script>
    <script src="{{asset('home2/js/scripts.js')}}"></script>
