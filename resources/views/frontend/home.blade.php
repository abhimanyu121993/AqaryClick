                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{asset('home2/assets/images/others/transparent-bg.png')}}" alt="slide image" data-src="{{asset('home2/./assets/images/agents/a-1.jpg')}}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
